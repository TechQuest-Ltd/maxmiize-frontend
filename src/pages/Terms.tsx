        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16'>
          <div className='p-4 md:p-8 lg:p-12'>
            ...
            <div className='max-w-none space-y-6 md:space-y-8 text-gray-700 animate-fade-in animation-delay-400'>
              ...
              <section>
                <h2 className='text-xl md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4'>Software Description</h2>
                <p className='text-base leading-relaxed'>
              ...
              <section>
                <h2 className='text-xl md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4'>Software License</h2>
                <p className='text-base leading-relaxed'>
              ...
              <section>
                <h2 className='text-xl md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4'>Permitted Use</h2>
                <p className='text-base leading-relaxed'>
              ...
              <section>
                <h2 className='text-xl md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4'>Intellectual Property</h2>
                <p className='text-base leading-relaxed'>
              ...
              <section>
                <h2 className='text-xl md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4'>Warranty and Support</h2>
                <p className='text-base leading-relaxed'>
              ...
              <section>
                <h2 className='text-xl md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4'>Termination</h2>
                <p className='text-base leading-relaxed'>
              ...
              <section>
                <h2 className='text-xl md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4'>Governing Law</h2>
                <p className='text-base leading-relaxed'>
              ...
              <section>
                <h2 className='text-xl md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4'>Performance Standards</h2>
                <p className='text-base leading-relaxed'>
              ...
              <section>
                <h2 className='text-xl md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4'>Supported File Formats</h2>
                <p className='text-base leading-relaxed'>
              ...
              <section>
                <h2 className='text-xl md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4'>Changes to Terms</h2>
                <p className='text-base leading-relaxed'>
              ...
              <section className='mt-12 pt-8 border-t border-gray-200'>
                <h2 className='text-xl md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4'>Contact Information</h2>
                <p className='text-base leading-relaxed'>
